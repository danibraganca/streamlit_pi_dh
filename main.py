...
with header:
    ...
    st.header('Descrição')
    st.text('A partir de dados de séries históricas de medições de vazões, chuvas e clima na') 
    st.text('bacia afluente à UHE Pedra do Cavalo (BA) prever o nível desse reservatório.')
    st.text('Esta informação tem impacto no abastecimento da região metropolitana de Salvador.')
    st.header('Time')
